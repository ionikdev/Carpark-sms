...
function Page() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      const response = await client.post("/admin", data);
        ...
        <div className="w-[95%] md:max-w-[80%] lg:h-[80vh] text-white md:mx-2 shadow-2xl shadow-red-500  bg-black py-5 px-5   rounded-2xl border border-gray-200">
          <div className="flex flex-col items-center justify-center gap-5 heading">
            ...
            <span className="text-center text-[14px] w-full md:w-[65%] text-gray-500">
              As the mastermind behind the scenes, our Admin orchestrates the
              platform's smooth functioning. They curate user experiences,
              ensure top-notch security measures, and make strategic decisions
              to enhance every interaction within the system.
            </span>
          </div>
