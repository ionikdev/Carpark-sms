...
const Header = (props: {
  ...
  return (
    <header className="sticky top-20 z-999 flex w-full bg-[#F8F9FC] drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between py-4 gap-3  shadow-2 md:px-6  mx-10 mt-5">
